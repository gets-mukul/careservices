 ...
 * City entities. Transaction control of the save(), update() and delete()
 * operations can directly support Spring container-managed transactions or they
 * can be augmented to handle user-managed Spring transactions. Each of these
 * methods provides additional information for how to configure it for the
 * desired type of transaction control.
 * 
 * @see com.careservices.dao.City
...
public class CityDAO extends BaseHibernateDAO {
	...
	public City findById(java.lang.Integer id) {
		...
		try {
			City instance = (City) getSession().get("com.careservices.dao.City", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<City> findByExample(City instance) {
		...
		try {
			List<City> results = (List<City>) getSession().createCriteria("com.careservices.dao.City")
