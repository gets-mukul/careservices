 ...
 * 
 * @see com.careservices.dao.Contact
...
public class ContactDAO extends BaseHibernateDAO {
	...
	public Contact findById(java.lang.Integer id) {
		...
		try {
			Contact instance = (Contact) getSession().get("com.careservices.dao.Contact", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Contact> findByExample(Contact instance) {
		...
		try {
			List<Contact> results = (List<Contact>) getSession().createCriteria("com.careservices.dao.Contact")
	...
	public List<Contact> findByContactLocation(Object contactLocation) {
		return findByProperty(CONTACT_LOCATION, contactLocation);
	}
	...
	public List<Contact> findByContactNumber(Object contactNumber) {
